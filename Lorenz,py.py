...
time_values = np.linspace(0, 40, 15000)
...
axis.plot(x, y, z, color="lime", linewidth=0.6)

axis.set_title("Lorenz Attractor: 3D Chaos Simulation", color="white", pad=20)
axis.set_xlabel("X axis", color="white")
axis.set_ylabel("Y axis", color="white")
axis.set_zlabel("Z axis", color="white")
